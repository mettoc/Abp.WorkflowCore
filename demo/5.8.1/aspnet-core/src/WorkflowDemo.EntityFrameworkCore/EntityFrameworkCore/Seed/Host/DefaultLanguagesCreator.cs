...
namespace WorkflowDemo.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        public static List<ApplicationLanguage> InitialLanguages => GetInitialLanguages();

        private readonly WorkflowDemoDbContext _context;

        private static List<ApplicationLanguage> GetInitialLanguages()
        {
            var tenantId = WorkflowDemoConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(WorkflowDemoDbContext context)
        {
            _context = context;
        }

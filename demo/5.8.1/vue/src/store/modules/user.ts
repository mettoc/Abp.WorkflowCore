...
class UserModule extends ListModule<UserState,any,User>{
    ...
    actions={
        ...
        async searchList(context: ActionContext<UserState, any>, payload: any) {
            let reponse = await Ajax.get('/api/services/app/User/GetUsers',{ params: payload.data ,paramsSerializer: function(params) {
